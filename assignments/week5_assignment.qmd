...
IGV Screenshot of _C. Gigas_ Genome assembly with mitochondrial DNA and GFF files
![IGV](week6_output/IGV_all.png)

IGV screenshot of zoomed in chromosome
![IGV](week6_output/IGV_zoom.png)

IGV Screenshot with Variants

For some reason, there are no variants found.
![IGV](week6_output/IGV_variants.png)
